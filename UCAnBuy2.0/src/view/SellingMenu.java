...
public class SellingMenu extends MyOwnJFrame {
    ...
    private void initComponents() {
        ...
        jTextFieldProductName.setCursor(new java.awt.Cursor(java.awt.Cursor.TEXT_CURSOR));
        ...
        jTextAreaDescription.setFont(new java.awt.Font("Times New Roman", 0, 13)); // NOI18N
        jTextAreaDescription.setForeground(new java.awt.Color(0, 102, 102));
    ...
    //    p.setProductImages(jTextFieldImagePath.getText());
        ...
        Util.ACTUAL_ADMIN.setId(Util.ACTUAL_USER.getUsername());
        
        adminExists = smc.adminExists(Util.ACTUAL_ADMIN.getUsername());
        
        if(adminExists){
            smc.addProductToAdminsInventory(Util.ACTUAL_ADMIN);
            log.warn("El admin existe");
        }else{
            smc.saveAdminInDataBase(Util.ACTUAL_ADMIN);
            log.warn("El admin no existe");
        }
