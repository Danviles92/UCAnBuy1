...
public class SignUp extends MyOwnJFrame {
    ...
    private void jButtonNextActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButtonNextActionPerformed
        ...
        Util.ACTUAL_USER.setName(jTextFieldName.getText());
        Util.ACTUAL_USER.setLastname(jTextFieldLastname.getText());
        Util.ACTUAL_USER.setId(jTextFieldIDNumber.getText());
        Util.ACTUAL_USER.setUsername(jTextFieldUsername.getText());
